...
| `100-times_table.c`      | `void print_times_table(int n)`  |
  `101-natural.c`            `void print_natural(int n)`
  `102-fibonacci.c`          `void print_fibonnaci(int n)`
  `103-fibonacci.c`          `void print_fibonacci(int n)`   
  `104-fibonacci.c`          `void print_fibonacci(int n)`
## Tasks :page_with_curl:

* **0. _putchar**
  * [0-main.c](./0-main.c): C program that prints `Best School`, followed by a
  new line. Returns 0.
